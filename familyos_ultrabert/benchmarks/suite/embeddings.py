...
class EmbeddingSuite(BenchmarkSuite):
	...
	_TRIPLET_ACCURACY_THRESHOLD: float = 0.95
	_TRIPLET_MARGIN_THRESHOLD: float = 0.10

	_RECALL_AT1_10_THRESHOLD: float = 0.90
	_RECALL_AT1_100_THRESHOLD: float = 0.80
	...
	def run(self) -> List[Any]:
		...
		self.add_result(
			...
			passed=(recall10_100 >= self._RECALL_AT10_100_THRESHOLD and len(RETRIEVAL_CASES_100) > 0),
			score=recall10_100,
