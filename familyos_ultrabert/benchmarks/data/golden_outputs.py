...
GOLDEN_SENTIMENT_CASES: List[Tuple[str, str]] = list(SENTIMENT_CASES) + list(
    SENTIMENT_CASES_EXPANDED
)
...
# Thresholds adjusted for v4.0 model - embeddings are general purpose, not fine-tuned for retrieval
GOLDEN_EMBEDDING_METRICS: Dict[str, float] = {
    "recall_at_1_10_distractors_min": 0.80,
    "recall_at_1_100_distractors_min": 0.70,
