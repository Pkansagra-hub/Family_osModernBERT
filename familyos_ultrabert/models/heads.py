...
# =============================================================================
# Label-Description Embedding Heads (V2 Architecture)
# =============================================================================
...
class IntentHeadV2(LabelDescriptionHead):
    ...
    Args:
        ...
        multi_label: Enable multi-label classification (default: True for K1)
        dropout: Dropout probability (default: 0.1)
    ...
    def __init__(
        ...
        projection_dim: int = 768,
        temperature: float = 0.07,
        multi_label: bool = True,  # K1 requirement: multi-label
        dropout: float = 0.1,
        confidence_threshold: float = 0.5,
    ):
        super().__init__(
...
class MultiGranularityRelevanceHead(BaseHead):
    ...
    def compute_maxsim(
        ...
        # Z-normalize: batch z-norm for multi-doc batches (preserves trained behaviour),
        # population z-norm only for single-pair scoring (batch_size=1)
        if maxsim.size(0) > 1:
...
__all__ = [
    ...
    "RelationHead",  # NEW
    "IntentHead",  # Legacy single-label
    "TemporalHead",  # NEW
